...
var dark = "Donker";
var light = "Licht";
var noPreview = "Geen voorbeeld beschikbaar";
var or = "OF";
var selectButtonTitle = "Selecteer";
var skipToContent = "Skip naar inhoud";
var submit = "Verzend";
var nl = {
    Analytics: Analytics,
    "Auth.components.Oops.text": "Je account is geblokkeerd.",
    "Auth.components.Oops.text.admin": "Als dit een fout is, neem dan contact op met je beheerder.",
    ...
    "Auth.form.error.blocked": "Je account werd geblokkeerd door de beheerder.",
    "Auth.form.error.code.provide": "Incorrecte code ingevoerd.",
    "Auth.form.error.confirmed": "Het e-mailadres voor je account is nog niet bevestigd.",
    ...
    "HomePage.addWidget.button": "Widget toevoegen",
    "HomePage.addWidget.noWidgetsAvailable": "Geen widgets beschikbaar om toe te voegen",
    "HomePage.addWidget.title": "Widget toevoegen",
    "HomePage.head.title": "Startpagina",
    "HomePage.header.subtitle": "Welkom bij je beheerpaneel",
    ...
    "HomePage.widget.delete": "Verwijderen",
    "HomePage.widget.drag": "Slepen om te verplaatsen",
    "HomePage.widget.error": "Kon widgetinhoud niet laden.",
    "HomePage.widget.loading": "Widgetinhoud laden",
    "HomePage.widget.no-data": "Geen inhoud gevonden.",
    "HomePage.widget.no-permissions": "Je hebt niet de rechten om deze widget te bekijken",
    ...
    "Settings.apiTokens.copy.lastWarning": "Kopieer je API-token",
    "Settings.apiTokens.create": "Token toevoegen",
    "Settings.apiTokens.createPage.BoundRoute.title": "Gekoppelde route naar",
    "Settings.apiTokens.createPage.permissions.description": "Hieronder staan alleen acties die aan een route zijn gebonden.",
    "Settings.apiTokens.createPage.permissions.header.hint": "Selecteer de acties van de applicatie of de plugin en klik op het tandwielpictogram om de gekoppelde route weer te geven",
    "Settings.apiTokens.createPage.permissions.header.title": "Geavanceerde instellingen",
    "Settings.apiTokens.createPage.permissions.title": "Rechten",
    "Settings.apiTokens.createPage.title": "API-token aanmaken",
    ...
    "Settings.apiTokens.lastHour": "afgelopen uur",
    "Settings.apiTokens.regenerate": "Opnieuw genereren",
    "Settings.apiTokens.title": "API Tokens",
    "Settings.application.customization": "Maatwerk",
    "Settings.application.customization.auth-logo.carousel-hint": "Vervang het logo op de inlogpagina's",
    ...
    "Settings.application.customization.carousel.auth-logo.title": "Inloglogo",
    "Settings.application.customization.carousel.change-action": "Pas logo aan",
    "Settings.application.customization.carousel.menu-logo.title": "Menulogo",
    ...
    "Settings.application.customization.menu-logo.carousel-hint": "Vervang het logo in de hoofdnavigatie",
    ...
    "Settings.application.customization.size-details": "Max. afmeting: {dimension}×{dimension}, Max. bestandsgrootte: {size}KB",
    ...
    "Settings.content-history.description": "Krijg meer controle over elke stap in de levenscyclus van je inhoud.",
    "Settings.content-history.not-available": "Inhoudsgeschiedenis is alleen beschikbaar als onderdeel van een betaald plan. Upgrade om volledige controle over de levenscyclus van je inhoud te krijgen.",
    "Settings.content-history.title": "Inhoudsgeschiedenis",
    "Settings.error": "Fout",
    "Settings.global": "Globale Instellingen",
    "Settings.page.PurchaseAudit-logs.description": "Volg en beoordeel wijzigingen met je team",
    "Settings.page.PurchaseAudit-logs.perks1": "Wijzigingen eenvoudig bijhouden",
    "Settings.page.PurchaseAudit-logs.perks2": "Wijzigingen makkelijk beoordelen",
    "Settings.page.PurchaseAudit-logs.perks3": "Beveiliging en compliance waarborgen",
    "Settings.page.PurchaseContent-history.description": "Herstel inhoudswijzigingen direct",
    "Settings.page.PurchaseContent-history.perks1": "Blader door je inhoudsgeschiedenis",
    "Settings.page.PurchaseContent-history.perks2": "Herstel wijzigingen met één klik",
    "Settings.page.PurchaseContent-history.perks3": "Volg wijzigingen over talen heen",
    "Settings.page.PurchaseSSO.description": "Vereenvoudig authenticatie voor je team",
    "Settings.page.PurchaseSSO.perks1": "Uniforme authenticatie",
    "Settings.page.PurchaseSSO.perks2": "Verbeterde beveiliging",
    "Settings.page.PurchaseSSO.perks3": "Ondersteuning voor webhooks",
    "Settings.page.purchase.learn-more.cta": "Meer informatie",
    "Settings.page.purchase.upgrade.cta": "Upgraden",
    "Settings.permissions": "Administratiepaneel",
    "Settings.permissions.auditLogs.action": "Actie",
    "Settings.permissions.auditLogs.admin.auth.success": "Beheerder ingelogd",
    "Settings.permissions.auditLogs.admin.logout": "Beheerder uitgelogd",
    "Settings.permissions.auditLogs.component.create": "Component aanmaken",
    "Settings.permissions.auditLogs.component.delete": "Component verwijderen",
    "Settings.permissions.auditLogs.component.update": "Component bijwerken",
    "Settings.permissions.auditLogs.content-type.create": "Contenttype aanmaken",
    "Settings.permissions.auditLogs.content-type.delete": "Contenttype verwijderen",
    "Settings.permissions.auditLogs.content-type.update": "Contenttype bijwerken",
    "Settings.permissions.auditLogs.date": "Datum",
    "Settings.permissions.auditLogs.details": "Logdetails",
    "Settings.permissions.auditLogs.entry.create": "Item aanmaken{model, select, undefined {} other { ({model})}}",
    "Settings.permissions.auditLogs.entry.delete": "Item verwijderen{model, select, undefined {} other { ({model})}}",
    "Settings.permissions.auditLogs.entry.publish": "Item publiceren {model, select, undefined {} other {({model})}}",
    "Settings.permissions.auditLogs.entry.unpublish": "Item depubliceren{model, select, undefined {} other { ({model})}}",
    "Settings.permissions.auditLogs.entry.update": "Item bijwerken{model, select, undefined {} other { ({model})}}",
    "Settings.permissions.auditLogs.filters.combobox.aria-label": "Zoek en selecteer een optie om te filteren",
    "Settings.permissions.auditLogs.listview.header.subtitle": "Logboek van alle activiteiten in je omgeving",
    "Settings.permissions.auditLogs.media.create": "Media aanmaken",
    "Settings.permissions.auditLogs.media.delete": "Media verwijderen",
    "Settings.permissions.auditLogs.media.update": "Media bijwerken",
    "Settings.permissions.auditLogs.not-available": "Auditlogs zijn alleen beschikbaar als onderdeel van een betaald plan. Upgrade om een doorzoekbaar en filterbaar overzicht van alle activiteiten te krijgen.",
    "Settings.permissions.auditLogs.payload": "Payload",
    "Settings.permissions.auditLogs.permission.create": "Recht aanmaken",
    "Settings.permissions.auditLogs.permission.delete": "Recht verwijderen",
    "Settings.permissions.auditLogs.permission.update": "Recht bijwerken",
    "Settings.permissions.auditLogs.role.create": "Rol aanmaken",
    "Settings.permissions.auditLogs.role.delete": "Rol verwijderen",
    "Settings.permissions.auditLogs.role.update": "Rol bijwerken",
    "Settings.permissions.auditLogs.user": "Gebruiker",
    "Settings.permissions.auditLogs.user.create": "Gebruiker aanmaken",
    "Settings.permissions.auditLogs.user.delete": "Gebruiker verwijderen",
    "Settings.permissions.auditLogs.user.fullname": "{firstname} {lastname}",
    "Settings.permissions.auditLogs.user.update": "Gebruiker bijwerken",
    "Settings.permissions.auditLogs.userId": "Gebruikers-ID",
    ...
    "Settings.permissions.conditions.conditions": "Voorwaarden",
    ...
    "Settings.permissions.users.sso.provider.error": "Er is een fout opgetreden bij het ophalen van de SSO-instellingen",
    ...
    "Settings.profile.form.section.experience.interfaceLanguageHelp": "Selectie zal de interfacetaal alleen voor jou veranderen. Raadpleeg deze {here} om andere talen beschikbaar te maken voor je team.",
    "Settings.profile.form.section.experience.mode.hint": "Toont je interface in de gekozen modus.",
    ...
    "Settings.profile.form.section.experience.mode.option-system-label": "Systeeminstellingen gebruiken",
    ...
    "Settings.sso.form.localAuthenticationLock.description": "Selecteer de rollen waarvoor je de lokale authenticatie wilt uitschakelen",
    "Settings.sso.form.localAuthenticationLock.label": "Lokale authenticatie vergrendeling",
    ...
    "Settings.sso.not-available": "SSO is alleen beschikbaar als onderdeel van een betaald plan. Upgrade om aanvullende inlog- en registratiemethoden voor je beheerpaneel te configureren.",
    "Settings.sso.title": "Single Sign-On",
    "Settings.tokens.Button.cancel": "Annuleren",
    "Settings.tokens.Button.regenerate": "Regenereren",
    "Settings.tokens.ListView.headers.createdAt": "Aangemaakt op",
    "Settings.tokens.ListView.headers.description": "Beschrijving",
    "Settings.tokens.ListView.headers.lastUsedAt": "Laatst gebruikt",
    "Settings.tokens.ListView.headers.name": "Naam",
    ...
    "Settings.tokens.form.description": "Beschrijving",
    "Settings.tokens.form.duration": "Token duur",
    "Settings.tokens.form.name": "Naam",
    "Settings.tokens.form.type": "Token type",
    "Settings.tokens.notification.copied": "Token gekopieerd naar klembord.",
    "Settings.tokens.popUpWarning.message": "Weet je zeker dat je dit token opnieuw wilt genereren?",
    "Settings.tokens.regenerate": "Opnieuw genereren",
    "Settings.tokens.types.custom": "Aangepast",
    "Settings.tokens.types.full-access": "Volledige toegang",
    "Settings.tokens.types.read-only": "Alleen lezen",
    "Settings.transferTokens.ListView.headers.type": "Tokentype",
    "Settings.transferTokens.addFirstToken": "Voeg je eerste Transfer Token toe",
    "Settings.transferTokens.addNewToken": "Nieuw Transfer Token toevoegen",
    "Settings.transferTokens.create": "Nieuw Transfer Token aanmaken",
    "Settings.transferTokens.createPage.title": "Transfer Token aanmaken",
    "Settings.transferTokens.description": "Overzicht van gegenereerde transfer tokens",
    "Settings.transferTokens.emptyStateLayout": "Je hebt nog geen inhoud...",
    ...
    "Settings.webhooks.event.select": "Selecteer event",
    "Settings.webhooks.events.create": "Creëer",
    "Settings.webhooks.events.delete": "Webhook verwijderen",
    "Settings.webhooks.events.isLoading": "Events laden",
    ...
    "Settings.webhooks.list.loading.success": "Webhooks zijn geladen",
    ...
    "Settings.webhooks.validation.key": "Sleutel is verplicht",
    "Settings.webhooks.validation.name.regex": "De naam moet beginnen met een letter en mag alleen letters, cijfers, spaties en underscores bevatten",
    "Settings.webhooks.validation.name.required": "Naam is verplicht",
    "Settings.webhooks.validation.url.regex": "De waarde moet een geldige URL zijn",
    "Settings.webhooks.validation.url.required": "URL is verplicht",
    "Settings.webhooks.validation.value": "Waarde is verplicht",
    ...
    "app.component.table.read": "{target} lezen",
    ...
    "app.components.BlockLink.cloud.content": "Volledig beheerde cloudhosting voor je Strapi-project.",
    ...
    "app.components.FreeTrialEndedModal.button.downgrade": "Downgraden naar Community",
    "app.components.FreeTrialEndedModal.button.upgrade": "Blijf op het Growth-plan",
    "app.components.FreeTrialEndedModal.description": "Je toegang tot Growth-planfuncties zoals Inhoudsgeschiedenis, Releases en Single Sign-On (SSO) is verlopen.",
    "app.components.FreeTrialEndedModal.notice.item1": "Downgraden verwijdert de toegang tot bovenstaande functies.",
    "app.components.FreeTrialEndedModal.notice.item2": "Documentversiegeschiedenis wordt verwijderd.",
    "app.components.FreeTrialEndedModal.notice.item3": "Alle releases worden gewist.",
    "app.components.FreeTrialEndedModal.notice.item4": "Als je downgradet, stel dan een wachtwoord in voor de hoofdbeheerder om toegang tot het beheerpaneel te behouden.",
    "app.components.FreeTrialEndedModal.notice.title": "Belangrijk om te weten:",
    "app.components.FreeTrialEndedModal.title": "Je proefperiode is afgelopen",
    "app.components.FreeTrialWelcomeModal.button": "Begin met verkennen",
    "app.components.FreeTrialWelcomeModal.description1": "De komende 30 dagen heb je volledige toegang tot geavanceerde functies zoals Inhoudsgeschiedenis, Releases en Single Sign-On (SSO) — alles wat je nodig heeft om de kracht van Strapi CMS te verkennen.",
    "app.components.FreeTrialWelcomeModal.description2": "Gebruik deze tijd om je contentworkflows met volledige flexibiliteit op te bouwen, aan te passen en te testen!",
    "app.components.FreeTrialWelcomeModal.title": "Fijn dat je aan boord bent",
    "app.components.GuidedTour.CM.create.content": "<p>Maak en beheer alle inhoud hier in de content manager.</p><p>Bijvoorbeeld: als we verder gaan met het blog-websitevoorbeeld, kan men een artikel schrijven, opslaan en publiceren zoals ze willen.</p>< p>💡 Snelle tip - Vergeet niet op publiceren te klikken bij de inhoud die je maakt.</p>",
    ...
    "app.components.GuidedTour.CTB.create.content": "<p>Verzamelingstypen helpen je bij het beheren van meerdere inzendingen. Enkele typen zijn geschikt om slechts één inzending te beheren.</p> <p>Bijvoorbeeld: voor een blogwebsite zijn Artikelen een verzamelingstype, terwijl een startpagina een enkelvoudig type is. </p>",
    ...
    "app.components.GuidedTour.apiTokens.create.content": "<p>Genereer hier een authenticatietoken en haal de inhoud op die je zojuist hebt gemaakt.</p>",
    ...
    "app.components.LeftMenu.trialCountdown.endedAt": "Je proefperiode is geëindigd op {date}.",
    "app.components.LeftMenu.trialCountdown.endsAt": "Je proefperiode eindigt op {date}.",
    ...
    "app.components.NpsSurvey.banner-title": "Hoe waarschijnlijk is het dat je Strapi aanbeveelt aan een vriend of collega?",
    "app.components.NpsSurvey.dismiss-survey-label": "Enquête sluiten",
    "app.components.NpsSurvey.feedback-question": "Heb je suggesties voor verbeteringen?",
    "app.components.NpsSurvey.feedback-response": "Hartelijk dank voor je feedback!",
    "app.components.NpsSurvey.happy-to-recommend": "Zeer waarschijnlijk",
    "app.components.NpsSurvey.no-recommendation": "Zeer onwaarschijnlijk",
    "app.components.NpsSurvey.select-rating": "Selecteer beoordeling",
    "app.components.NpsSurvey.submit-feedback": "Feedback verzenden",
    ...
    "app.components.Onboarding.link.build-content": "Bouw een inhoudsstructuur",
    "app.components.Onboarding.link.manage-content": "Inhoud toevoegen en beheren",
    "app.components.Onboarding.link.manage-media": "Media beheren",
    "app.components.Onboarding.link.more-videos": "Bekijk meer video's",
    ...
    "app.components.ToggleCheckbox.disabled-label": "Uitgeschakeld",
    "app.components.ToggleCheckbox.enabled-label": "Ingeschakeld",
    "app.components.ToggleCheckbox.off-label": "Uit",
    "app.components.ToggleCheckbox.on-label": "Aan",
    "app.components.UpsellBanner.button": "Nu upgraden",
    "app.components.UpsellBanner.intro": "Toegang tot Growth-planfuncties: ",
    "app.components.UpsellBanner.text": "Als onderdeel van je proefperiode kunt je premiumtools verkennen zoals Inhoudsgeschiedenis, Releases en Single Sign-On (SSO).",
    ...
    "app.confirm.body": "Weet je het zeker?",
    ...
    "app.page.not.found": "Oeps! We kunnen de pagina die je zoekt niet vinden...",
    "app.static.links.cheatsheet": "Spiekbriefje",
    "app.utils.SelectOption.defaultMessage": " ",
    "app.utils.add-filter": "Voeg filter toe",
    "app.utils.already-published": "Reeds gepubliceerd",
    ...
    "app.utils.published": "Gepubliceerd",
    "app.utils.ready-to-publish": "Klaar om te publiceren",
    "app.utils.ready-to-publish-changes": "Klaar om wijzigingen te publiceren",
    "app.utils.ready-to-unpublish-changes": "Klaar om te depubliceren",
    "app.utils.refresh": "Vernieuwen",
    ...
    "app.utils.update-filter": "Filter bijwerken",
    ...
    "components.Blocks.blocks.unorderedList": "Ongeordende lijst",
    "components.Blocks.collapse": "Samenvouwen",
    "components.Blocks.dnd.instruction": "Om blokken te herschikken drukt je op Command of Control samen met Shift en de pijltoetsen omhoog of omlaag",
    "components.Blocks.dnd.reorder": "{item}, verplaatst. Nieuwe positie in de editor: {position}.",
    "components.Blocks.expand": "Uitvouwen",
    "components.Blocks.link": "Link",
    "components.Blocks.modifiers.bold": "Vet",
    "components.Blocks.modifiers.code": "Inline code",
    "components.Blocks.modifiers.italic": "Cursief",
    "components.Blocks.modifiers.strikethrough": "Doorhalen",
    "components.Blocks.modifiers.underline": "Onderstrepen",
    "components.Blocks.popover.edit": "Bewerken",
    "components.Blocks.popover.link": "Link",
    "components.Blocks.popover.link.error": "Voer een geldige link in",
    "components.Blocks.popover.link.placeholder": "Plak link",
    "components.Blocks.popover.link.rel": "Rel (optioneel)",
    "components.Blocks.popover.link.rel.placeholder": "noopener, nofollow, noreferrer",
    "components.Blocks.popover.link.target": "Target (optioneel)",
    ...
    "components.Blocks.popover.text.placeholder": "Voer linktekst in",
    ...
    "components.Input.error.contain.maxBytes": "Wachtwoord mag niet groter zijn dan 73 bytes",
    ...
    "components.Input.error.validation.combobox.invalid": "De opgegeven waarde is niet geldig",
    "components.Input.error.validation.email": "Dit is geen e-mailadres",
    "components.Input.error.validation.email.withField": "{field} is geen geldig e-mailadres",
    "components.Input.error.validation.json": "Dit komt niet overeen met het JSON-formaat",
    "components.Input.error.validation.json.withField": "{field} komt niet overeen met het JSON-formaat",
    "components.Input.error.validation.lowercase": "De waarde moet in kleine letters zijn",
    "components.Input.error.validation.lowercase.withField": "{field} moet een kleine letter-tekst zijn",
    "components.Input.error.validation.max": "De waarde is te hoog {max}.",
    "components.Input.error.validation.max.withField": "{field} is te hoog.",
    "components.Input.error.validation.maxLength": "De waarde is te lang {max}.",
    "components.Input.error.validation.maxLength.withField": "{field} is te lang.",
    "components.Input.error.validation.min": "De waarde is te laag {min}.",
    "components.Input.error.validation.min.withField": "{field} is te laag.",
    "components.Input.error.validation.minLength": "De waarde is te kort {min}.",
    "components.Input.error.validation.minLength.withField": "{field} is te kort.",
    "components.Input.error.validation.minSupMax": "Mag niet superieur zijn.",
    "components.Input.error.validation.minSupMax.withField": "{field} kan niet hoger zijn",
    "components.Input.error.validation.regex": "De ingevoerde waarde komt niet overeen met de regex.",
    "components.Input.error.validation.regex.withField": "{field} komt niet overeen met de regex.",
    "components.Input.error.validation.required": "Deze waarde is verplicht.",
    "components.Input.error.validation.required.withField": "{field} is verplicht.",
    "components.Input.error.validation.string": "Dit is geen geldige tekst.",
    "components.Input.error.validation.unique": "Deze waarde is al gebruik.",
    "components.Input.error.validation.unique.withField": "{field} is al in gebruik.",
    ...
    "components.ViewSettings.tooltip": "Weergave-instellingen",
    ...
    "components.premiumFeature.title": "Premiumfunctie",
    dark: dark,
    ...
    "global.error": "Er is iets misgegaan",
    "global.finish": "Einde",
    "global.fullname": "{firstname} {lastname}",
    "global.home": "Home",
    "global.last-change.redo": "Laatste wijziging opnieuw uitvoeren",
    "global.last-change.undo": "Laatste wijziging ongedaan maken",
    "global.last-changes.discard": "Laatste wijzigingen verwerpen",
    "global.learn-more": "Meer informatie",
    "global.localeToggle.label": "Selecteer interfacetaal",
    ...
    "global.plugins.content-manager.description": "Snelle manier om de gegevens in je database te bekijken, bewerken en verwijderen.",
    "global.plugins.content-type-builder": "Content-Type Bouwer",
    "global.plugins.content-type-builder.description": "Modelleer de datastructuur van je API. Creëer nieuwe velden en relaties in slechts een minuut. De bestanden worden automatisch aangemaakt en bijgewerkt in je project.",
    "global.plugins.documentation": "Documentatie",
    "global.plugins.documentation.description": "Maak een OpenAPI-document en visualiseer je API met SWAGGER UI.",
    "global.plugins.email": "E-mail",
    "global.plugins.email.description": "Configureer je applicatie om e-mails te verzenden.",
    ...
    "global.plugins.users-permissions.description": "Bescherm je API met een volledig authenticatieproces op basis van JWT. Deze plug-in wordt ook geleverd met een ACL-strategie waarmee je de machtigingen tussen de groepen gebruikers kunt beheren.",
    "global.profile": "Profiel",
    "global.profile.settings": "Profielinstellingen",
    ...
    "notification.ee.warning.at-seat-limit.title": "{licenseLimitStatus, select, OVER_LIMIT {Over} AT_LIMIT {Op}} de licentielimiet ({currentUserCount}/{permittedSeats})",
    "notification.ee.warning.over-.message": "Voeg licenties toe om gebruikers te {licenseLimitStatus, select, OVER_LIMIT {uitnodigen} AT_LIMIT {heractiveren}}. Als je dit al heeft gedaan maar het nog niet zichtbaar is in Strapi, herstart dan je applicatie.",
    "notification.error": "Er is een fout opgetreden",
    "notification.error.invalid.configuration": "Je hebt een ongeldige configuratie. Controleer het serverlogboek voor meer informatie.",
    ...
    "notification.success.transfertokencreated": "Transfer Token succesvol aangemaakt",
    "notification.success.transfertokenedited": "Transfer Token succesvol bewerkt",
    ...
    submit: submit,
    "tours.apiTokens.CopyAPIToken.content": "Klik op de \"Kopiëren\" knop om je API-token op te slaan. Je hebt dit nodig om verzoeken naar je applicatie te sturen. {spacer} Heb je nog vragen? Lees meer over <a>API-tokens</a>.",
    "tours.apiTokens.CopyAPIToken.title": "Kopieer je API-token",
    "tours.apiTokens.FinalStep.content": "Je hebt alles wat je nodig heeft om je applicatie te deployen en inhoud met de wereld te delen.",
    "tours.apiTokens.FinalStep.title": "Gefeliciteerd, het is tijd om je applicatie te deployen!",
    "tours.apiTokens.Introduction.content": "Beheer API-toegang met uitgebreid aanpasbare rechten.",
    "tours.apiTokens.Introduction.title": "Tot slot: API-tokens",
    "tours.apiTokens.ManageAPIToken.content": "Klik op het \"Potlood\"-pictogram om een bestaand API-token te bekijken en bij te werken.",
    "tours.apiTokens.ManageAPIToken.title": "Een API-token beheren",
    "tours.apiTokens.ViewAPIToken.content": "Klik op de \"Token bekijken\" knop om je API-token te zien.",
    "tours.apiTokens.ViewAPIToken.title": "API-token bekijken",
    "tours.contentManager.CreateNewEntry.content": "Klik op de knop \"Nieuw item aanmaken\" om een nieuw item voor dit collectietype aan te maken en te publiceren.",
    "tours.contentManager.CreateNewEntry.title": "Nieuw item aanmaken",
    "tours.contentManager.Fields.content": "Vul eerst de velden in die je in de Content-Type Builder heeft aangemaakt.",
    "tours.contentManager.Fields.title": "Velden",
    "tours.contentManager.FinalStep.content": "Nu je een item heeft aangemaakt en gepubliceerd, gaan we een API-token instellen om de toegang tot je inhoud te beheren.",
    "tours.contentManager.FinalStep.title": "Tijd om API-tokens in te stellen!",
    "tours.contentManager.Introduction.content": "Maak en beheer inhoud van je collectietypes en enkele types.",
    "tours.contentManager.Introduction.title": "Content Manager",
    "tours.contentManager.Publish.content": "Klik vervolgens op de knop \"Publiceren\" om je inhoud beschikbaar te maken via de content-API.",
    "tours.contentManager.Publish.title": "Publiceren",
    "tours.contentTypeBuilder.AIChat.content": "<p>Heb je vragen over de Content-Type Builder of Strapi? Stel ze hier.</p><p>Strapi AI kan schema's genereren die zijn afgestemd op je behoeften. Vraag precies wat je wilt, bijvoorbeeld:<ul><li>Datumkiezer</li><li>E-mail- en wachtwoordvelden</li><li>Media van elk type</li><li>UID's</li></ul></p><p>Probeer het gerust uit!</p>",
    "tours.contentTypeBuilder.AIChat.title": "Tijd om te beginnen!",
    "tours.contentTypeBuilder.AddFields.content": "Begin met het toevoegen van je eerste veld — zoals een naam, afbeelding of relatie. Je contenttype heeft een structuur nodig voordat het inhoud kan bevatten.",
    "tours.contentTypeBuilder.AddFields.title": "Voeg een veld toe om het tot leven te brengen",
    "tours.contentTypeBuilder.CollectionTypes.content": "Dit zijn je standaardkeuze voor het beheren van meerdere items — denk aan blogposts of producten.",
    "tours.contentTypeBuilder.CollectionTypes.title": "Collectietypes",
    "tours.contentTypeBuilder.Components.content": "Eenmaal bouwen, overal hergebruiken. Gebruik componenten voor zaken als knoppen, kaarten of sliders.",
    "tours.contentTypeBuilder.Components.title": "Componenten",
    "tours.contentTypeBuilder.Finish.content": "Je hebt je eerste contenttype gebouwd! Ga nu naar het Content Manager om items toe te voegen!",
    "tours.contentTypeBuilder.Finish.title": "Eerste stap: klaar! 🎉",
    "tours.contentTypeBuilder.Introduction.content": "Hier maakt en beheert je de structuur van je applicatie met collectietypes, enkele types en herbruikbare componenten. Laten we beginnen!",
    "tours.contentTypeBuilder.Introduction.title": "Welkom bij de Content-Type Builder!",
    "tours.contentTypeBuilder.Save.content": "Klik op de \"Opslaan\" knop om je contenttype vast te leggen en je werk niet te verliezen. Bijna klaar!",
    "tours.contentTypeBuilder.Save.title": "Vergeet niet op te slaan!",
    "tours.contentTypeBuilder.SingleTypes.content": "Perfect voor eenmalige items zoals je homepagina of site-instellingen.",
    "tours.contentTypeBuilder.SingleTypes.title": "Enkele types",
    "tours.contentTypeBuilder.YourTurn.content": "Maak een collectietype of enkel type aan. Klik op de \"+\" knop, kies een naam, klik op \"Doorgaan\" en wij begeleiden je verder.",
    "tours.contentTypeBuilder.YourTurn.title": "Je beurt — Bouw iets!",
    "tours.gotIt": "Begrepen",
    "tours.next": "Volgende",
    "tours.overview.apiTokens.label": "Een API-token kopiëren",
    "tours.overview.close": "Rondleiding sluiten",
    "tours.overview.close.description": "Weet je zeker dat je de rondleiding wilt sluiten?",
    "tours.overview.completed": "{completed}% voltooid",
    "tours.overview.contentManager.label": "Inhoud aanmaken en publiceren",
    "tours.overview.contentTypeBuilder.label": "Maak je schema",
    "tours.overview.strapiCloud.label": "Je applicatie deployen naar Strapi Cloud",
    "tours.overview.strapiCloud.link": "Documentatie lezen",
    "tours.overview.subtitle": "Volg de rondleiding om het meeste uit Strapi te halen.",
    "tours.overview.tasks": "Je taken",
    "tours.overview.title": "Ontdek je applicatie!",
    "tours.overview.tour.done": "Voltooid",
    "tours.overview.tour.link": "Start",
    "tours.profile.description": "Je kunt de rondleiding op elk moment opnieuw starten.",
    "tours.profile.notification.success.reset": "Rondleiding opnieuw gestart",
    "tours.profile.reset": "Rondleiding opnieuw starten",
    "tours.profile.title": "Rondleiding",
    "tours.skip": "Overslaan",
    "tours.stepCount": "Stap {currentStep} van {tourLength}",
    "widget.key-statistics.list.admins": "Beheerders",
    "widget.key-statistics.list.apiTokens": "API-tokens",
    "widget.key-statistics.list.assets": "Bestanden",
    "widget.key-statistics.list.components": "Componenten",
    "widget.key-statistics.list.contentTypes": "Contenttypes",
    "widget.key-statistics.list.entries": "Items",
    "widget.key-statistics.list.locales": "Talen",
    "widget.key-statistics.list.webhooks": "Webhooks",
    "widget.key-statistics.title": "Projectstatistieken",
    "widget.last-activity.link": "Auditlogs openen",
    "widget.last-activity.no-activity": "Geen activiteit",
    "widget.last-activity.title": "Laatste activiteit",
    "widget.profile.title": "Profiel"
};

export { Analytics, Documentation, Email, Password, Provider, ResetPasswordToken, Role, Username, Users, anErrorOccurred, clearLabel, dark, nl as default, light, noPreview, or, selectButtonTitle, skipToContent, submit };
