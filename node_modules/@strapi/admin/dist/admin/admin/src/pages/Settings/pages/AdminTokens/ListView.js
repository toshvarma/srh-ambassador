...
const ListView = ()=>{
    ...
    const permissions = hooks.useTypedSelector((state)=>state.admin_app.permissions.settings?.['admin-tokens']);
    ...
    const { data: adminTokens = [], isLoading, error } = apiTokens.useGetAdminTokensQuery();
    React__namespace.useEffect(()=>{
        if (error) {
            toggleNotification({
                type: 'danger',
    ...
    const [deleteToken] = apiTokens.useDeleteAdminTokenMutation();
        ...
        children: [
            ...
            !canRead ? /*#__PURE__*/ jsxRuntime.jsx(PageHelpers.Page.NoPermissions, {}) : /*#__PURE__*/ jsxRuntime.jsx(PageHelpers.Page.Main, {
                ...
                children: /*#__PURE__*/ jsxRuntime.jsxs(Layout.Layouts.Content, {
                    children: [
                        adminTokens.length > 0 && /*#__PURE__*/ jsxRuntime.jsx(Table.Table, {
                            permissions: {
                                canRead,
                                canDelete,
                                canUpdate
                        ...
                        canCreate && adminTokens.length === 0 ? /*#__PURE__*/ jsxRuntime.jsx(designSystem.EmptyStateLayout, {
...
const ProtectedListView = ()=>{
    const permissions = hooks.useTypedSelector((state)=>state.admin_app.permissions.settings?.['admin-tokens']?.main);
