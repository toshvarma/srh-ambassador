...
import { createDynamicActionPermissionChecker, createFieldPermissionChecker } from '../utils/createPermissionChecker.mjs';
import { difference } from '../utils/difference.mjs';
import { createDefaultForm, createDefaultCTForm } from '../utils/forms.mjs';
...
import { updateValuesWithPermissions, updateValues } from '../utils/updateValues.mjs';
...
const Permissions = /*#__PURE__*/ React.forwardRef(({ layout, isFormDisabled, permissions = [], userPermissions }, api)=>{
    ...
    const handleChangeCollectionTypeLeftActionRowCheckbox = React.useCallback((pathToCollectionType, propertyName, rowName, value)=>{
        dispatch({
    ...
    const handleChangeCollectionTypeGlobalActionCheckbox = React.useCallback((collectionTypeKind, actionId, value)=>{
        dispatch({
    ...
    const handleChangeConditions = React.useCallback((conditions)=>{
        dispatch({
