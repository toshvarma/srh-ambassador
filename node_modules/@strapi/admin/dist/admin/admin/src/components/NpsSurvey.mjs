...
import { Field, Portal, Box, Flex, Typography, IconButton, SingleSelect, SingleSelectOption, VisuallyHidden, Textarea, Button } from '@strapi/design-system';
                                    ...
                                    isMobile ? /*#__PURE__*/ jsx(Box, {
                                        ...
                                        children: /*#__PURE__*/ jsx(SingleSelect, {
                                            ...
                                            children: ratingArray.sort((a, b)=>b - a).map((number)=>{
                                                ...
                                                return /*#__PURE__*/ jsxs(SingleSelectOption, {
                                                    value: number,
                                                    children: [
                                                        number,
                                                        " ",
