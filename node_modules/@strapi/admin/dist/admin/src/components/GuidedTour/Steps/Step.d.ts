...
declare const DefaultActions: ({ showSkip, showPrevious, to, tourName, onNextStep, onPreviousStep, }: DefaultActionsProps) => import("react/jsx-runtime").JSX.Element | null;
type WithChildren = {
