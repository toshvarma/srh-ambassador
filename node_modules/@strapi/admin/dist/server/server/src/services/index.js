...
const contentApiTokenService = apiToken.createTokenService('content-api');
const adminTokenService = apiToken.createTokenService('admin');
...
var services = {
    ...
    condition,
    action,
    /** @deprecated Use 'api-token-content-api' instead */ 'api-token': contentApiTokenService,
