 ...
 */ const hasUserConfiguredAuthOptionsExpiresIn = (adminAuthOptions)=>{
    if (adminAuthOptions == null || typeof adminAuthOptions !== 'object') {
        return false;
    }
    return adminAuthOptions.expiresIn != null;
};
/**
...
exports.hasUserConfiguredAuthOptionsExpiresIn = hasUserConfiguredAuthOptionsExpiresIn;
