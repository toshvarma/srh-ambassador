...
function createComponentBuilder() {
    return {
        ...
        createContentTypeAttributes (uid, attributes$1) {
            ...
            Object.keys(attributes$1).forEach((key)=>{
                const { target } = attributes$1[key];
                if (target === '__self__') {
                    attributes$1[key].target = uid;
                }
            });
            contentType.setAttributes(this.convertAttributes(attributes$1));
            Object.keys(attributes$1).forEach((key)=>{
