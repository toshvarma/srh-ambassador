...
import { createTextShape, createStringShape, validators, isNameAllowed, NAME_REGEX, isMinSuperiorThanMax, alreadyUsedAttributeNames } from './validation/common.mjs';
