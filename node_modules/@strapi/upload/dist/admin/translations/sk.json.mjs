var sk = {
    ...
    "assets.uploaded": "{number, plural, one {# súbor} other {# súbory}} boli úspešne nahraté",
    "asset-details.title": "Podrobnosti súboru",
    "asset-details.description": "Zobrazuje informácie o súbore a metadáta",
    "asset-details.fileInfo": "Informácie o súbore",
    "asset-details.error": "Nepodarilo sa načítať podrobnosti súboru.",
    "asset-details.videoNotSupported": "Váš prehliadač nepodporuje video tag.",
    "asset-details.size": "Veľkosť",
    "asset-details.dimensions": "Rozmery",
    "asset-details.duration": "Trvanie",
    "asset-details.creationDate": "Dátum vytvorenia",
    "asset-details.lastUpdated": "Naposledy aktualizované",
    "asset-details.createdBy": "Vytvoril",
    "asset-details.extension": "Prípona",
    "asset-details.assetId": "ID súboru",
    "asset-details.fileName": "Názov súboru",
    "asset-details.caption": "Popis",
    "asset-details.alternativeText": "Alternatívny text",
    "asset-details.noPreview": "Náhľad nie je k dispozícii",
    "upload.generic-error": "Počas nahrávania súboru nastala chyba.",
    "upload.progress": "Priebeh nahrávania",
    "upload.progress.description": "Zobrazuje priebeh a stav nahrávania",
    "upload.progress.failed": "Nahrávanie zlyhalo",
    "upload.progress.failed.subtitle": "Skúste prosím súbory nahrať znova",
    "upload.progress.success": "Nahrávanie úspešné!",
    "upload.progress.success.subtitle": "{count, plural, one {# súbor bol úspešne nahratý} other {# súbory boli úspešne nahraté}}",
    "upload.progress.success.subtitle.withErrors": "{successCount} nahratých, {errorCount} zlyhalo",
    "upload.progress.uploading.withCount": "Nahráva sa {total} položiek ({percentage}%)",
    "upload.progress.uploading-files": "Nahráva sa {count, plural, one {# súbor} other {# súbory}}",
    "upload.progress.indicator.in-progress": "Indikátor prebiehajúceho nahrávania",
    "upload.progress.indicator.complete": "Indikátor dokončeného nahrávania",
    "upload.progress.label": "Nahrávanie",
    "upload.progress.errors.title": "Nepodarilo sa nahrať:",
    "upload.progress.cancel": "Zrušiť",
    "upload.progress.canceled": "Nahrávania zrušené",
    "upload.progress.canceled.subtitle": "Niektoré súbory neboli nahraté",
    "upload.progress.canceled.subtitle.all": "Všetky nahrávania boli zrušené",
    "upload.progress.retry": "Skúsiť znova",
    "upload.progress.file.uploading": "Nahráva sa...",
    "upload.progress.file.canceled": "Zrušené",
    "upload.progress.file.uploaded": "Nahraté",
    "upload.progress.maximize": "Maximalizovať",
    "upload.progress.minimize": "Minimalizovať",
    "upload.progress.close": "Zavrieť",
    ...
    "control-card.set-focal-point": "Nastaviť fokálny bod",
    "control-card.stop-focal-point": "Zrušiť výber fokálneho bodu",
    "control-card.reset-focal-point": "Obnoviť na stred",
    "control-card.save-focal-point": "Uložiť fokálny bod",
    "control-card.download": "Stiahnúť",
    "control-card.edit": "Upraviť",
    "control-card.remove-selection": "Odstrániť z výberu",
    "control-card.replace-media": "Nahradiť súbor",
    "control-card.save": "Uložiť",
    "control-card.stop-crop": "Ukončiť orezávanie",
    "dropzone.upload.message": "Pustite sem na nahratie do",
    ...
    "form.input.placeholder.file-caption": "Zadajte popis",
    ...
    "folder.create.title": "Nový priečinok",
    "folder.form.name.label": "Názov priečinka",
    "folder.create.submit": "Vytvoriť priečinok",
    "folder.create.form.error.name-required": "Názov je povinný",
    "folder.create.form.error.unknown": "Počas vytvárania priečinka sa vyskytla chyba",
    "folder.create.success": "Priečinok bol vytvorený",
    ...
    "header.content.item-count": "{count, plural, =1 {# položka} other {# položky}}",
    "import-files": "Nahratie súboru",
    "import-from-url": "Nahratie súboru z URL",
    ...
    "input.url.label": "URL",
    "input.url.placeholder": "Prázdne",
    "input.notification.not-supported": "Tento typ súboru nemôžete nahrať, akceptované sú iba nasledujúce typy – {fileTypes}",
    ...
    "list.assets.error": "Počas načítavania súborov sa vyskytla chyba.",
    "list.assets.loading-more": "Načítava sa viac súborov...",
    ...
    "list-assets-select": "Vybrať súbor {name}",
    ...
    "list.folder.select": "Vybrať priečinok {name}",
    ...
    "list.folders.link-label": "Prístup k priečinku",
    ...
    "modal.file-details.focal-point": "Fokálny bod",
    ...
    "settings.form.aiMetadata.label": "Generovať AI popisy a alternatívne texty automaticky pri nahrávaní!",
    "settings.form.aiMetadata.description": "Zapnite túto funkciu, aby ste ušetrili čas, optimalizovali SEO a zvýšili prístupnosť tým, že naša AI za vás vygeneruje popisy a alternatívne texty.",
    "settings.form.aiMetadata.allAssetsHaveMetadata": "Všetky súbory majú popis a alternatívny text",
    "settings.form.aiMetadata.imagesWithoutMetadata": "{count, plural, one {# obrázku chýba popis alebo alternatívny text} other {# obrázkom chýba popis alebo alternatívny text}}",
    "settings.form.aiMetadata.generatingMetadata": "AI generuje vaše metadáta",
    "settings.form.aiMetadata.metadataGenerated": "Vaše metadáta boli vygenerované",
    "settings.form.aiMetadata.generateButton": "Generovať metadáta",
    "settings.form.aiMetadata.confirmDialog.title": "Generovať AI metadáta",
    "settings.form.aiMetadata.confirmDialog.message": "Týmto sa na pozadí spustí proces generovania popisov a alternatívnych textov pre {count, plural, one {# obrázok} other {# obrázky}}. AI môže robiť chyby, preto si vygenerovaný obsah nezabudnite skontrolovať.",
    ...
    "list.table.header.actions": "akcie",
    "list.table.header.preview": "náhľad",
    "list.table.header.name": "názov",
    "list.table.header.ext": "prípona",
    "list.table.header.size": "veľkosť",
    "list.table.header.createdAt": "vytvorené",
    "list.table.header.updatedAt": "posledná úprava",
    "list.table.header.creationDate": "Dátum vytvorenia",
    "list.table.header.lastModified": "Posledná úprava",
    "list.table.header.sort": "Zoradiť podľa {label}",
    "list.table.content.empty-label": "Toto pole je prázdne",
    ...
    "config.back": "Späť",
    "config.subtitle": "Definujte nastavenia zobrazenia knižnice súborov.",
    "config.entries.title": "Počet záznamov na stránku",
    "config.sort.title": "Predvolené poradie zoradenia",
    "config.entries.note": "Počet súborov zobrazených predvolene v Knižnici súborov",
    "config.note": "Poznámka: Túto hodnotu môžete prepísať v knižnici súborov.",
    "config.popUpWarning.warning.updateAllSettings": "Týmto upravíte všetky svoje nastavenia",
    "view-switch.list": "Zobrazenie zoznamu",
    "view-switch.grid": "Zobrazenie mriežky",
    "view.switch.label": "Možnosti zobrazenia",
    "view.table": "Tabuľkové zobrazenie",
    "view.grid": "Mriežkové zobrazenie",
    "ai.modal.uploading.title": "Nahrávanie a spracovanie pomocou AI...",
    "ai.modal.title": "{count, plural, one {# súbor nahratý} other {# súbory nahraté}}, skontrolujte AI vygenerované metadáta",
    "ai.modal.error": "Pre nahraté súbory sa nepodarilo vygenerovať AI metadáta."
};
