...
import { FILE_MODEL_UID, ACTIONS } from '../constants.mjs';
import { validateUploadBody, validateBulkUpdateBody } from './validation/admin/upload.mjs';
...
var adminUpload = {
    async bulkUpdateFileInfo (ctx) {
        ...
        const results = await async.map(updates, async ({ id, fileInfo })=>{
