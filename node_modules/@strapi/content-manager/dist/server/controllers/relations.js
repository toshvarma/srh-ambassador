 ...
 */ const addStatusToRelations = async (targetUid, relations)=>{
    ...
    const statusByDocumentId = documentStatus.indexByDocumentId(availableStatus);
    return relations.map((relation)=>{
        const candidates = statusByDocumentId.get(relation.documentId) || [];
        const availableStatuses = relation.locale ? candidates.filter((c)=>c.locale === relation.locale) : candidates;
        return {
            ...relation,
