...
declare function getService<T extends keyof PreviewServices>(strapi: Core.Strapi, name: T): ReturnType<{
    ...
    'preview-config': ({ strapi }: {
        ...
        isEnabled(): boolean;
        validate(): void;
        getPreviewHandler(): (uid: string, params: import("@strapi/types/dist/core/config/admin").PreviewHandlerParams) => string | Promise<string | null | undefined> | null | undefined;
    };
}[T]>;
export { getService };
