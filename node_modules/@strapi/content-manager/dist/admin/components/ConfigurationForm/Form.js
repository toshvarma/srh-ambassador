                       ...
                       */ if (!attributes.ATTRIBUTE_TYPES_THAT_CANNOT_BE_MAIN_FIELD.includes(attribute.type)) {
                                        ...
                                        /*#__PURE__*/ jsxRuntime.jsx(designSystem.Grid.Item, {
                                            ...
                                            children: /*#__PURE__*/ jsxRuntime.jsx(strapiAdmin.InputRenderer, {
                                                type: "enumeration",
                                                label: formatMessage({
                                                    id: translations.getTranslation('containers.SettingPage.editSettings.relationOpenMode'),
                                                    defaultMessage: 'Relation open behavior'
                                                }),
                                                hint: formatMessage({
                                                    id: translations.getTranslation('containers.SettingPage.editSettings.relationOpenMode.description'),
                                                ...
                                                options: [
                                                    {
                                                        label: formatMessage({
                                                            id: translations.getTranslation('containers.SettingPage.editSettings.relationOpenMode.modal'),
                                                    ...
                                                    {
                                                        label: formatMessage({
                                                            id: translations.getTranslation('containers.SettingPage.editSettings.relationOpenMode.page'),
                                                    ...
                                                    {
                                                        label: formatMessage({
                                                            id: translations.getTranslation('containers.SettingPage.editSettings.relationOpenMode.newTab'),
