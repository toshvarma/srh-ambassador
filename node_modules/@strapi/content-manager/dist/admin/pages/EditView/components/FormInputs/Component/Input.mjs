...
import { NonRepeatableComponent as MemoizedNonRepeatableComponent } from './NonRepeatable.mjs';
import { RepeatableComponent as MemoizedRepeatableComponent } from './Repeatable.mjs';
...
const ComponentInput = ({ label, required, name, attribute, disabled, labelAction, ...props })=>{
    ...
    return /*#__PURE__*/ jsxs(Field.Root, {
        ...
        children: [
            ...
            !attribute.repeatable && field.value ? /*#__PURE__*/ jsx(MemoizedNonRepeatableComponent, {
                attribute: attribute,
                name: name,
                disabled: disabled,
                ...props,
