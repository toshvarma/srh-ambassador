...
const HeaderDocumentActions = ({ activeTab, isCloning })=>{
    ...
    return /*#__PURE__*/ jsxRuntime.jsx(strapiAdmin.DescriptionComponentRenderer, {
        ...
        children: (actions)=>{
            ...
            return /*#__PURE__*/ jsxRuntime.jsxs(DocumentActions.DocumentActionsMenu, {
                ...
                children: [
                    collectionType !== collections.SINGLE_TYPES && /*#__PURE__*/ jsxRuntime.jsx(CopyDocumentIdMenuItem, {
                        documentId: documentId
                    }),
                    /*#__PURE__*/ jsxRuntime.jsx(Information, {
                        activeTab: activeTab
                    })
                ]
            });
...
const CopyDocumentIdMenuItem = ({ documentId })=>{
    const { formatMessage } = reactIntl.useIntl();
...
const Information = ({ activeTab })=>{
    const { formatMessage } = reactIntl.useIntl();
    const { document, meta, id, collectionType } = useDocument.useDoc();
    if (!document?.id && !id) {
        return null;
    }
    /**
   ...
   */ const createAndUpdateDocument = activeTab === 'draft' ? document : meta?.availableStatus?.find((status)=>status.publishedAt === null);
    ...
    const information = [
        ...
        {
            isDisplayed: collectionType !== collections.SINGLE_TYPES && !!(document?.documentId ?? id),
            label: formatMessage({
