...
var continueList = require('./utils/continueList.js');
...
const Editor = /*#__PURE__*/ React__namespace.forwardRef(({ disabled, editorRef, error, isPreviewMode, isExpandMode, name, onChange, placeholder, textareaRef, value }, forwardedRef)=>{
    ...
    React__namespace.useEffect(()=>{
        ...
        CodeMirror.commands.newlineAndIndentContinueMarkdownList = continueList.newlineAndIndentContinueMarkdownList;
    ...
    return /*#__PURE__*/ jsxRuntime.jsxs(EditorAndPreviewWrapper, {
        children: [
            ...
            isPreviewMode && /*#__PURE__*/ jsxRuntime.jsx(PreviewWysiwyg.PreviewWysiwyg, {
                data: value
            })
        ]
    });
