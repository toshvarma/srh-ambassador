 ...
 */ const BaseInputRenderer = ({ visible, hint: providedHint, document: providedDocument, ...inputProps })=>{
   ...
   */ const canUserReadField = canUserAction(props.name, readableFields, props.type);
    ...
    const renderComponentInput = React__namespace.useCallback((componentInputProps)=>/*#__PURE__*/ jsxRuntime.jsx(MemoizedInputRenderer, {
            ...componentInputProps
 ...
 */ const ConditionAwareInputRenderer = ({ condition, ...props })=>{
    ...
    const conditionDependencyPaths = React__namespace.useMemo(()=>conditionalFields.getConditionDependencyPaths(condition), [
        condition
    ]);
    const getValues = strapiAdmin.useForm('ConditionalInputRenderer', (state)=>state.getValues);
    const conditionSubscriptionValue = strapiAdmin.useForm('ConditionalInputRenderer', (state)=>{
        // Subscribe to a small, comparable snapshot of the parent scope instead of all form values.
        return conditionalFields.getConditionDependencySubscriptionValue(data.getDirectParent(state.values, props.name), conditionDependencyPaths);
    });
    ...
    const targetValues = conditionDependencyPaths === null ? conditionSubscriptionValue : data.getDirectParent(getValues(), props.name);
