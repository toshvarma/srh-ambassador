...
const RelationModalTrigger = ({ children, relation })=>{
    ...
    if (relationOpenMode === 'newTab') {
        return /*#__PURE__*/ jsx(StyledRelationLink, {
            to: fullPageUrl,
            target: "_blank",
...
`;
const StyledRelationLink = styled(Link)`
  max-width: 100%;
  font-size: ${({ theme })=>theme.fontSizes[2]};
  overflow: hidden;
  white-space: nowrap;
...
export { RelationModalRenderer, generateCreateUrl, getCollectionType, getFullPageUrl, reducer, useRelationModal };
