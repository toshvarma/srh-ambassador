...
const CustomRelationInput = (props)=>{
   ...
   */ let formattedFieldValue;
    ...
    const missingCount = hasResultsShape && typeof formattedFieldValue.meta?.missingCount === 'number' ? formattedFieldValue.meta.missingCount : 0;
 ...
 */ const resolveComponentRenderResources = (componentUID, componentsLayout, configurationComponents, components)=>{
        ...
        case 'component':
            {
                ...
                if (!renderResources) {
                    return /*#__PURE__*/ jsxRuntime.jsx(designSystem.Field.Label, {
                        children: props.label
                    });
                }
...
exports.CustomRelationInput = CustomRelationInput;
exports.VersionInputRenderer = VersionInputRenderer;
exports.resolveComponentRenderResources = resolveComponentRenderResources;
