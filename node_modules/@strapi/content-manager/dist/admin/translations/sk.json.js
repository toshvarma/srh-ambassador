...
var sk = {
    ...
    "actions.clone.error": "Pri pokuse o duplikovanie dokumentu sa vyskytla chyba.",
    "actions.clone.label": "Duplikovať",
    "actions.delete.dialog.body": "Naozaj chcete odstrániť tento dokument? Táto akcia je nevratná.",
    "actions.delete.error": "Pri pokuse o odstránenie dokumentu sa vyskytla chyba.",
    "actions.delete.label": "Odstrániť záznam{isLocalized, select, true { (všetky lokalizácie)} other {}}",
    "actions.discard.label": "Zahodiť zmeny",
    "actions.discard.dialog.body": "Naozaj chcete zahodiť zmeny? Táto akcia je nevratná.",
    "actions.edit.error": "Pri pokuse o úpravu dokumentu sa vyskytla chyba.",
    "actions.edit.label": "Upraviť",
    "actions.unpublish.error": "Pri pokuse o zrušenie publikovania dokumentu sa vyskytla chyba.",
    "actions.unpublish.dialog.body": "Naozaj chcete zrušiť publikovanie?",
    "actions.unpublish.dialog.option.keep-draft": "Zrušiť publikovanie a ponechať posledný návrh",
    "actions.unpublish.dialog.option.replace-draft": "Zrušiť publikovanie a nahradiť posledný návrh",
    ...
    "components.DynamicZone.extra-components": "{number, plural, =0 {Nie sú žiadne extra komponenty} one {Je tu # extra komponent} other {Sú tu # extra komponenty}}",
    ...
    "components.DynamicZone.move-up": "Posunúť vyššie",
    "components.DynamicZone.move-down": "Posunúť nižšie",
    ...
    "components.Filters.usersSelect.label": "Vyhľadať a vybrať používateľa na filtrovanie",
    ...
    "components.RelationInput.icon-button-aria-label": "Pretiahnuť",
    "components.RelationInputModal.modal-title": "Upraviť vzťah",
    "components.RelationInputModal.button-fullpage": "Prejsť na záznam",
    "components.RelationInputModal.confirmation-message": "Niektoré zmeny neboli uložené. Naozaj chcete zavrieť tento vzťah? Všetky neuložené zmeny sa stratia.",
    ...
    "bulk-publish.already-published": "Už publikované",
    "bulk-unpublish.already-unpublished": "Už nepublikované",
    "bulk-publish.modified": "Pripravené na publikovanie zmien",
    "bulk-publish.waiting-for-action": "Čaká na akciu",
    ...
    "containers.edit.tabs.draft": "návrh",
    "containers.edit.tabs.published": "publikované",
    "containers.edit.panels.default.title": "Záznam",
    "containers.edit.panels.default.more-actions": "Ďalšie akcie dokumentu",
    ...
    "containers.edit.header.more-actions": "Ďalšie akcie",
    "containers.edit.information.last-published.label": "Publikované",
    "containers.edit.information.last-published.value": "{time}{isAnonymous, select, true {} other { by {author}}}",
    "containers.edit.information.last-draft.label": "Aktualizované",
    "containers.edit.information.last-draft.value": "{time}{isAnonymous, select, true {} other { by {author}}}",
    "containers.edit.information.document.label": "Vytvorené",
    ...
    "containers.EditView.saveHint": "Ctrl / Cmd + Enter pre {action}",
    ...
    "containers.List.modified": "Upravené",
    "containers.List.statusFilter.draft": "Návrh (nikdy nepublikované)",
    "containers.List.statusFilter.published": "Publikované (všetko)",
    "containers.List.statusFilter.publishedModified": "Publikované (upravené)",
    "containers.List.statusFilter.publishedUnmodified": "Publikované (neupravené)",
    ...
    "containers.list.table.row-actions": "Akcie riadku",
    "containers.list.selectedEntriesModal.title": "Publikovať záznamy",
    "containers.list.selectedEntriesModal.selectedCount.publish": "<b>{publishedCount}</b> {publishedCount, plural, =0 {záznamov} one {záznam} other {záznamy}} už publikované. <b>{draftCount}</b> {draftCount, plural, =0 {záznamov} one {záznam} other {záznamy}} pripravené na publikovanie. <b>{withErrorsCount}</b> {withErrorsCount, plural, =0 {záznamov} one {záznam} other {záznamy}} čakajú na akciu.",
    "containers.list.selectedEntriesModal.selectedCount.unpublish": "<b>{draftCount}</b> {draftCount, plural, =0 {záznamov} one {záznam} other {záznamy}} už nepublikované. <b>{publishedCount}</b> {publishedCount, plural, =0 {záznamov} one {záznam} other {záznamy}} pripravené na zrušenie publikovania.",
    "containers.list.autoCloneModal.header": "Duplikovať",
    "containers.list.autoCloneModal.title": "Tento záznam nie je možné priamo duplikovať.",
    "containers.list.autoCloneModal.description": "Bude vytvorený nový záznam s rovnakým obsahom, ale aby ste ho mohli uložiť, budete musieť zmeniť nasledujúce polia.",
    "containers.list.autoCloneModal.create": "Vytvoriť",
    "containers.list.autoCloneModal.error.unique": "Rovnaké hodnoty v jedinečnom poli nie sú povolené.",
    "containers.list.autoCloneModal.error.relation": "Duplikovanie vzťahu by ho mohlo odstrániť z pôvodného záznamu.",
    "containers.list-settings.modal-form.label": "Upraviť {fieldName}",
    "containers.list-settings.modal-form.error": "Pri pokuse o otvorenie formulára sa vyskytla chyba.",
    "containers.edit-settings.modal-form.error": "Pri pokuse o otvorenie formulára sa vyskytla chyba.",
    "containers.edit-settings.modal-form.label": "Názov",
    "containers.edit-settings.modal-form.description": "Popis",
    "containers.edit-settings.modal-form.placeholder": "Placeholder",
    "containers.edit-settings.modal-form.mainField": "Názov záznamu",
    "containers.edit-settings.modal-form.mainField.hint": "Nastavte zobrazované pole v zobrazení úprav aj zoznamu",
    "containers.edit-settings.modal-form.editable": "Editovateľné pole",
    "containers.edit-settings.modal-form.size": "Veľkosť",
    ...
    "containers.SettingPage.editSettings.relationOpenMode": "Správanie otvárania vzťahov",
    "containers.SettingPage.editSettings.relationOpenMode.description": "Vyberte, ako sa budú otvárať záznamy vzťahov po kliknutí",
    "containers.SettingPage.editSettings.relationOpenMode.modal": "Modálne okno (predvolené)",
    "containers.SettingPage.editSettings.relationOpenMode.newTab": "Otvoriť v novej karte",
    "containers.SettingPage.editSettings.relationOpenMode.page": "Prejsť na stránku",
    ...
    "containers.SettingPage.relations": "Súvisiace polia",
    ...
    "dnd.grab-item": "{item}, uchopené. Aktuálna pozícia v zozname: {position}. Na zmenu pozície stlačte šípku hore a dole, medzerník na pustenie, Escape na zrušenie.",
    "dnd.instructions": "Stlačte medzerník na uchopenie a zmenu poradia",
    "dnd.reorder": "{item}, presunuté. Nová pozícia v zozname: {position}.",
    ...
    "error.records.fetch-draft-relatons": "Pri načítavaní vzťahov návrhov v tomto dokumente sa vyskytla chyba.",
    ...
    "form.Input.hint.character.unit": "{maxValue, plural, one { znak} other { znakov}}",
    ...
    "popUpWarning.bodyMessage.contentType.delete": "Naozaj chcete odstrániť Content-Type?",
    "popUpWarning.bodyMessage.contentType.delete.all": "Naozaj chcete odstrániť tieto záznamy?",
    "popUpWarning.bodyMessage.contentType.publish.all": "Naozaj chcete publikovať tieto záznamy?",
    "popUpWarning.bodyMessage.contentType.unpublish.all": "Naozaj chcete zrušiť publikovanie týchto záznamov?",
    "popUpWarning.warning.has-draft-relations.title": "Potvrdenie",
    "popUpWarning.warning.has-draft-relations.message": "Tento záznam je prepojený s {count, plural, one {# návrhom záznamu} other {# návrhmi záznamov}}. Jeho publikovanie môže vo vašej aplikácii zanechať nefunkčné odkazy.",
    ...
    "popUpwarning.warning.bulk-has-draft-relations.message": "<b>{count} {count, plural, one { vzťah } other { vzťahy } } z {entities} { entities, plural, one { záznamu } other { záznamov } } {count, plural, one { nie je } other { nie sú } }</b> ešte publikované a môžu viesť k neočakávanému správaniu. ",
    "popUpWarning.warning.publish-question": "Stále si prajete publikovať?",
    "popUpWarning.warning.unpublish": "Ak tento obsah nepublikujete, automaticky sa zmení na návrh.",
    "popUpWarning.warning.unpublish-question": "Naozaj ho nechcete publikovať?",
    "popUpWarning.warning.updateAllSettings": "Toto upraví všetky vaše nastavenia",
    "popover.display-relations.label": "Zobraziť prepojenia",
    "preview.panel.title": "Náhľad",
    "preview.panel.button": "Otvoriť náhľad",
    "preview.panel.button-configuration": "Nastaviť náhľad",
    "preview.panel.button-disabled-tooltip": "Prosím uložte pre otvorenie náhľadu",
    "preview.page-title": "Náhľad {contentType}",
    "preview.header.close": "Zavrieť náhľad",
    "preview.copy.label": "Kopírovať odkaz náhľadu",
    "preview.copy.success": "Odkaz náhľadu bol skopírovaný",
    "preview.tabs.label": "Stav náhľadu",
    "preview.content.close-editor": "Zavrieť editor",
    "preview.content.open-editor": "Otvoriť editor",
    "preview.device.select": "Vyberte typ zariadenia",
    "preview.device.desktop": "Desktop",
    "preview.device.mobile": "Mobil",
    "preview.info.single-click-hint": "Dvojklik pre úpravu",
    "preview.error.invalid-field-path": "Nepodarilo sa nájsť toto pole v aktuálnom dokumente",
    "preview.error.relations-not-handled": "Inline úprava vzťahov momentálne nie je podporovaná.",
    "preview.error.incomplete-strapi-source": "Tomuto poľu chýbajú niektoré povinné informácie pre náhľad",
    "preview.error.different-document": "Toto pole pochádza z iného dokumentu",
    "relation.create": "Vytvoriť vzťah",
    "relation.add": "Pridať alebo vytvoriť vzťah",
    "relation.disconnect": "Odstrániť",
    "relation.error-adding-relation": "Pri pokuse o pridanie vzťahu sa vyskytla chyba.",
    "relation.isLoading": "Vzťahy sa načítavajú",
    "relation.loadMore": "Načítať viac",
    "relation.notAvailable": "Nie sú dostupné žiadne vzťahy",
    "relation.publicationState.draft": "Návrh",
    "relation.publicationState.published": "Publikované",
    "reviewWorkflows.stage.label": "Fáza kontroly",
    "select.currently.selected": "{count} aktuálne vybrané",
    "success.record.clone": "Dokument bol duplikovaný",
    "success.record.discard": "Zmeny boli zahodené",
    "success.record.delete": "Zmazané",
    "success.record.publish": "Publikované",
    "success.record.publishing": "Publikovanie...",
    "success.record.save": "Uložené",
    "success.record.unpublish": "Nepublikované",
    "success.records.delete": "Úspešne odstránené.",
    "success.records.unpublish": "Publikovanie bolo úspešne zrušené.",
    "success.records.publish": "Úspešne publikované.",
    "utils.data-loaded": "{number, plural, =1 {Záznam bol úspešne načítaný} other {Záznamy boli úspešne načítané}}",
    "listView.validation.errors.title": "Vyžaduje sa akcia",
    "listView.validation.errors.message": "Pred publikovaním sa uistite, že všetky polia sú platné (povinné pole, min/max limit znakov atď.)",
    "history.document-action": "História obsahu",
    "history.page-title": "História {contentType}",
    "history.sidebar.title": "Verzie",
    "history.sidebar.version-card.aria-label": "Karta verzie",
    "history.sidebar.versionDescription": "{distanceToNow}{isAnonymous, select, true {} other { od {author}}}{isCurrent, select, true { <b>(aktuálna)</b>} other {}}",
    "history.sidebar.show-newer": "Zobraziť novšie verzie",
    "history.sidebar.show-older": "Zobraziť staršie verzie",
    "history.version.subtitle": "{hasLocale, select, true {{subtitle}, v {locale}} other {{subtitle}}}",
    "history.content.new-field.title": "Nové pole",
    "history.content.new-field.message": "Toto pole neexistovalo, keď bola táto verzia uložená. Ak obnovíte túto verziu, zostane prázdne.",
    "history.content.unknown-fields.title": "Neznáme polia",
    "history.content.unknown-fields.message": "Tieto polia boli odstránené alebo premenované v Tvorcovi obsahových typov. <b>Tieto polia nebudú obnovené.</b>",
    "history.content.missing-assets.title": "{number, plural, =1 {Chýbajúci súbor} other {{number} chýbajúcich súborov}}",
    "history.content.missing-assets.message": "{number, plural, =1 {Bol odstránený} other {Boli odstránené}} v Knižnici médií a nie je možné ho obnoviť.",
    "history.content.missing-relations.title": "{number, plural, =1 {Chýbajúci vzťah} other {{number} chýbajúcich vzťahov}}",
    "history.content.missing-relations.message": "{number, plural, =1 {Bol odstránený a nie je možné ho obnoviť.} other {Boli odstránené a nie je možné ich obnoviť.}}",
    "history.content.no-relations": "Žiadne vzťahy.",
    "history.content.localized": "Táto hodnota je špecifická pre túto lokalizáciu. Ak obnovíte túto verziu, obsah nebude nahradený pre ostatné lokalizácie.",
    "history.content.not-localized": "Táto hodnota je spoločná pre všetky lokalizácie. Ak obnovíte túto verziu, obsah bude nahradený pre všetky lokalizácie.",
    "history.restore.confirm.button": "Obnoviť",
    "history.restore.confirm.title": "Naozaj chcete obnoviť túto verziu?",
    "history.restore.confirm.message": "{isDraft, select, true {Obnovený obsah prepíše váš návrh.} other {Obnovený obsah nebude publikovaný, prepíše návrh a uloží sa ako čakajúce zmeny. Zmeny budete môcť kedykoľvek publikovať.}}",
    "history.restore.success.title": "Verzia bola obnovená.",
    "history.restore.success.message": "Predchádzajúca verzia obsahu bola obnovená.",
    "history.restore.error.message": "Verziu nebolo možné obnoviť.",
    "validation.error": "Vo vašom dokumente sú validačné chyby. Pred uložením ich prosím opravte.",
    "validation.error.unreadable-required-field": "Vaše aktuálne oprávnenia neumožňujú prístup k niektorým povinným poliam. Požiadajte administrátora o prístup, aby ste mohli pokračovať.",
    "bulk-publish.edit": "Upraviť",
    ...
    "widget.last-edited.no-data": "Žiadne upravené záznamy",
    "widget.last-published.title": "Naposledy publikované záznamy",
    "widget.last-published.no-data": "Žiadne publikované záznamy",
    "actions-drawer.open": "Otvoriť ďalšie akcie",
    "actions-drawer.close": "Zavrieť ďalšie akcie"
};
