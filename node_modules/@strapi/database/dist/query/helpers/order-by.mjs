 ...
 */ const toKnexOrderByDescriptor = (db, tableName, rootTableAlias, entry)=>{
...
export { buildStatusSortExpression, getStrapiOrderColumnAlias, processOrderBy, toKnexOrderByDescriptor, wrapWithDeepSort };
