...
const createQueryBuilder = (uid, db, initialState = {})=>{
     ...
     */ ensurePaginationOrderStability () {
            ...
            const idColumnName = transform.toColumnName(meta, 'id');
       ...
       */ if (state.joins.length > 0) {
            ...
            if (state.orderBy.length > 0) {
                ...
                const knexOrderBy = state.orderBy.map((entry)=>orderBy.toKnexOrderByDescriptor(db, tableName, this.alias, entry));
