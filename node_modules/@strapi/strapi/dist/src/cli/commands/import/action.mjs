...
import { file, strapi as strapi$1, engine, directory } from '@strapi/data-transfer';
 ...
 */ var action = (async (opts)=>{
    ...
    const source = (await fse.stat(backupPath)).isDirectory() ? directory.providers.createLocalDirectorySourceProvider({
        directory: {
            path: backupPath
        }
