...
INSERT INTO `srhub_user_usergroup_map` (`user_id`, `group_id`)
SELECT u.id, g.id FROM `srhub_users` u, `srhub_usergroups` g
...
INSERT INTO `srhub_ambassador_user_meta` (`user_id`, `first_name`, `last_name`, `app_role`)
SELECT id, 'Sophia',  'Student',   'Student'        FROM `srhub_users` WHERE email = 'student.sophia@srh.de';
SELECT id, 'Emma',    'Exchange',  'ExchangeStudent' FROM `srhub_users` WHERE email = 'exchange.emma@srh.de';

INSERT INTO `srhub_ambassador_user_meta` (`user_id`, `first_name`, `last_name`, `app_role`)
SELECT id, 'Thomas',  'Professor', 'Professor'      FROM `srhub_users` WHERE email = 'prof.thomas@srh.de';

INSERT INTO `srhub_ambassador_user_meta` (`user_id`, `first_name`, `last_name`, `app_role`)
SELECT id, 'Anna',    'Teacher',   'Teacher'        FROM `srhub_users` WHERE email = 'teacher.anna@srh.de';

INSERT INTO `srhub_ambassador_user_meta` (`user_id`, `first_name`, `last_name`, `app_role`)
SELECT id, 'Lars',    'Ambassador','Ambassador'     FROM `srhub_users` WHERE email = 'ambassador.lars@srh.de';

INSERT INTO `srhub_ambassador_user_meta` (`user_id`, `first_name`, `last_name`, `app_role`)
SELECT id, 'Klaus',   'Admin',     'Admin'          FROM `srhub_users` WHERE email = 'admin.klaus@srh.de';

INSERT INTO `srhub_ambassador_user_meta` (`user_id`, `first_name`, `last_name`, `app_role`)
SELECT id, 'Super',   'Admin',     'SuperAdmin'     FROM `srhub_users` WHERE email = 'superadmin@srh.de';
